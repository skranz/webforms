...
form.ui.simple = function(form, fields=form$fields, values=NULL, submitBtn=NULL, submitLabel=texts$submitBtnLabel,add.submit=TRUE,lang=form[["lang"]], postfix = form$postfix, prefix = form$prefix, add.form.alert=TRUE, texts = form$texts, ...) {
